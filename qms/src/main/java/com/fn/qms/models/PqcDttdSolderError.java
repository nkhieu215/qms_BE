...
@Setter
@Entity
@Table(name="pqc_dttd_solder_error")
@NamedQuery(name="PqcDttdSoderError.findAll", query="SELECT p FROM PqcDttdSolderError p")
public class PqcDttdSolderError implements Serializable {
