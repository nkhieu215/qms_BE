...
@Setter
@Entity
@Table(name = "pqc_step_view")
@NamedQuery(name = "PqcWorkOrderViewStep.findAll", query = "SELECT p FROM PqcWorkOrderViewStep p")
public class PqcWorkOrderViewStep implements Serializable {
