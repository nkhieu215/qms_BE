...
public class Citt1 implements Serializable {
    ...
    public Citt1(Citt1PK citt1PK) {
        this.citt1PK = citt1PK;
    }

    public Citt1(Citt1PK citt1PK, String uType, BigDecimal uQuantity, String uIssue) {
        this.citt1PK = citt1PK;
        this.uType = uType;
    ...
    public Citt1(int docEntry, int lineId) {
        this.citt1PK = new Citt1PK(docEntry, lineId);
    }

    public Citt1PK getCitt1PK() {
        return citt1PK;
    }
